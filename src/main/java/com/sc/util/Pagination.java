...
public class Pagination{
	...
	public Pagination(HttpServletRequest servletRequest) {
		String p_currentPage = servletRequest.getParameter("page");
		String p_limitSize = servletRequest.getParameter("rows");	//limit size
		String p_sortField = servletRequest.getParameter("sidx");
		String p_sortOrder = servletRequest.getParameter("sord");
